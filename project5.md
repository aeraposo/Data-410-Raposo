...
![Math](https://render.githubusercontent.com/render/math?math=h_\lambda(\beta)=\begin{cases}\lambda|\beta|\text{%20,%20if%20%20}|\beta|\leq\lambda\\\frac{a\lambda|\beta|-\beta^2-\lambda^2}{a-1}\text{%20,%20if%20%20}\lambda%3C|\beta|{\leq}a\lambda\\\frac{\lambda^2(a%2B1)}{2}\text{%20,%20if%20%20}|\beta|%3Ea\lambda\end{cases})<br/>
