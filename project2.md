...
* Weights (![Math](https://render.githubusercontent.com/render/math?math=W_i)) are computed for each observation (![Math](https://render.githubusercontent.com/render/math?math=x_i)) by plugging the Euclidean distance between this observation and each other observation into the selected kernal function. These weights are represented in an dianal nxn matrix (where n is the number of observations).<br/>
...
```
<img src="./mse_rfr_min_samp_split_plot.png" width="400"><br/><br/>
