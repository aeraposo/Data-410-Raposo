...
**Important concept:** Linear regression gives us a predicted $y$, known as $ŷ$. Linear regression can be seen as a linear combination of the observed outputs (values of the dependent variable)<br/>
**Why?** We have 
$$X^Ty=X^TXβ+\sigma X^Tϵ$$
